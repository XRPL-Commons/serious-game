<template>
    <div class="rounded-full bg-transparent p-2 transition-all flex justify-center items-center mt-20">        
        <template v-if="isConnected">
            ...
            <br/>
            <div v-if="nftBought">
              Congratulations you now own XRPL Commons magazine winning NFT. You can see it online <a :href="'https://test.bithomp.com/nft/' + nftId" target="_blank">here</a>
            </div>
        </template>              
        <QRCodeModal :visible="modalVisible" :qrCodeSrc="qrCodeSrc" :isConnection="isConnection" @close="modalVisible = false"/>
